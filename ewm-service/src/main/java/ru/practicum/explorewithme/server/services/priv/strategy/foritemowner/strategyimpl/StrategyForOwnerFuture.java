...
public class StrategyForOwnerFuture implements StrategyForItemOwner {
    ...
    public List<BookingDto> findBookingByStrategy(Long ownerId, Pageable page) {
        ...
        return bookingRepository.findBookingsByItem_Owner_IdAndStartAfter(ownerId, date, page)
